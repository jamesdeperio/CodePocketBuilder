...
import jamesdeperio.github.com.codepocket.base.BaseDrawerActivity
import javax.inject.Inject

abstract class DIBaseDrawerActivity : BaseDrawerActivity(), HasFragmentInjector, HasSupportFragmentInjector {
    @Inject
